        ...
        return (
          ...
          <div className="form-group mb-3 col-lg-4">
            ...
            <div className="description-sm">
                ...
                {this.state.validator.message('title', this.state.title, 'required')}                    
            </div>
        </div> 
        <div className="form-group mb-3 col-lg-4">
            <label className="col-xl-3 col-sm-4">Categorii</label>
            { this.state.categories.map((i,j) =>
              <span key={j} className="m-2">{this.getContent(i)}</span>
              )
            }
            <div className="description-sm">
          ...
          <div className="my-1 mx-auto text-center">
          <Button onClick={(e) => this.previewMenu(this.state.products, this.state.categories)}>Vizualizeaza meniul</Button>
          </div>
          {  this.state.result &&        
            <div className="my-1 mx-auto text-center">
            <QRCode value={"http://menu.bathtimestories.com/menu/"+this.state.title} />
            </div>
          }
          </>
