				...
				props.products ? 
					this.state = {
						validator : new SimpleReactValidator(),
							...
							ingredients: props.products.ingredients,
							size: props.products.size,
							pictures: props.products.pictures,
					} :
					this.state = {
							validator : new SimpleReactValidator(),
							name: '<h3>Nume produs</h3>',
							description: '<p>Descriere exemplu. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>',
							ingredients: '<p>Lorem, ipsum, dolor, sit, amet, consectetur, adipiscing, elit</p>',
							size: '<div><ul><li>Mica | 5.00 lei</li><li>Medie | 8.00 lei</li><li>Mare | 12.00 lei</li></ul></div>',
							pictures: [
									{ img: '' },
							],
					}
	  ...
	  const {show, onCancel, data} = this.props;
		return (
          ...
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">Nou produs</Modal.Title>
          </Modal.Header>
										...
										<ul className="file-upload-product row">
												{
														this.state.pictures.map((res, i) => {
																return (
																		<li key={i} className="col-lg-3 row">
