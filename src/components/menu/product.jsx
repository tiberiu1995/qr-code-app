  ...
  constructor(props) {
    ...
    props.products
      ...
      : (this.state = {
          ...
          description:
            "<p>Descriere exemplu. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>",
          ingredients:
            "<p>Lorem, ipsum, dolor, sit, amet, consectetur, adipiscing, elit</p>",
          size:
            "<div><ul><li>Mica | 5.00 lei</li><li>Medie | 8.00 lei</li><li>Mare | 12.00 lei</li></ul></div>",
          pictures: [{ img: "" }],
        });
  }
                    ...
                    <div className="form-group mb-3 col-lg-12">
                      ...
                      <div className="description-sm">
                        <Editor
                          ...
                          onEditorChange={(x, y) =>
                            this.handleEditorChange(x, y, "name")
                          }
                        />
                    ...
                    <div className="form-group mb-3 col-lg-12">
                      ...
                      <div className="description-sm">
                        <Editor
                          ...
                          onEditorChange={(x, y) =>
                            this.handleEditorChange(x, y, "ingredients")
                          }
                        />
                        {this.state.validator.message(
                          "ingredients",
                    ...
                    <div className="form-group mb-3 col-lg-12">
                      ...
                      <div className="description-sm">
                        <Editor
                          ...
                          onEditorChange={(x, y) =>
                            this.handleEditorChange(x, y, "description")
                          }
                        />
                        {this.state.validator.message(
                          "description",
                    ...
                    <div className="form-group mb-3 col-lg-12">
                      ...
                      <div className="description-sm">
                        <Editor
                          ...
                          onEditorChange={(x, y) =>
                            this.handleEditorChange(x, y, "size")
                          }
                        />
                        {this.state.validator.message(
                          "size",
