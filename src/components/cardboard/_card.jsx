    ...
    <Card ref={dragRef} className="mb-2 p-0">
      <CardActionArea className="d-flex">
        ...
        <CardContent ref={dropRef} className="d-block col-lg-9">
          ...
          <Typography className="float-left" gutterBottom variant="p" component="p">
            {props.data.ingredients}
          </Typography>
          <Box className="float-right">
            {props.edit ? <Edit className="" size="small" color="primary" onClick={(e) => props.edit(props.data.id)}/> : ''}
            <Delete className="" size="small" color="primary" onClick={(e) => props.remove(props.data.id)}/>
         </Box>
        </CardContent>
