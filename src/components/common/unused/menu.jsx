...
export class Menu extends Component {
  ...
  componentDidMount() {
    ...
    if (title) this.fetchMenu(title);
    if (this.props.location.state) this.setState(this.props.location.state);
  }
                ...
                {this.state.products &&
                  this.state.products
                    ...
                    .map((j) => (
                      <div
                        key={j.id}
                        className="row col-12 col-sm-12 col-lg-10 m-2"
                      >
                        <div className="col-8 col-sm-8">
                          ...
                          />
                          <div
                            dangerouslySetInnerHTML={{ __html: j.ingredients }}
                          />
                        ...
                        <div className="col-4 col-sm-4">
                          <img
                            width="100%"
                            src={j.pictures[0] ? j.pictures[0].img : ""}
                          />
                        </div>
                      </div>
                    ))}
...
export default compose(withFirebase, connect(null))(injectIntl(Menu));
