...
import Cart from '../../../pages/menu/view/cart.jsx';
...
const NavBar = (props) => {
  ...
  const showModal = () => setState({...state, show: true})

  const hideModal = () => setState({...state, show: false})
          ...
          <Box display="flex" justifyContent="space-between" style={{flex: '1 1 auto'}}>
            ...
            { 
              <Box display="flex">  
                  ...
                  <Cart show={state.show} onCancel={hideModal} />
