...
//import Sidebar from '../../../../admin/components/common/sidebar_components/sidebar';
...
class SideBar extends Component {
    ...
    render() {
        const admin = window.location.pathname.includes('ct-admin') ? true : false;
        return (
            <div id="mySidenav" className="sidenav page-wrapper">
