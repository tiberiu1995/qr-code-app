            ...
            <IntlProvider locale='ro' messages={messages['ro']}>
             <ThemeProvider theme={this.theme}>
              <BrowserRouter basename={'/'} >
                <ScrollContext>
                  <Switch>
                      <Route path={`${process.env.PUBLIC_URL}/scan-qr/`} component={ScanQR}/>
                      {/* <Route exact path={`${process.env.PUBLIC_URL}/menu/`} component={MenuShow}/> */}
                      <Route exact path={`${process.env.PUBLIC_URL}/my-menu/:title`} component={CustomerMenu}/>
                      <Layout>
                      {/*Routes For Extra Pages*/}
                      <Route path={`${process.env.PUBLIC_URL}/test`} component={Container}/>
                      ...
                      <Route exact path={`${process.env.PUBLIC_URL}/menu/new`} component={MenuForm}/>

                      <Route exact path={`${process.env.PUBLIC_URL}/menu`} component={Menus}/>
                      <Route exact path={`${process.env.PUBLIC_URL}/menu/:title`} component={Menus}/>
                      <Route exact path={`${process.env.PUBLIC_URL}/menu/:title/categories/`} component={Categories}/>
                      <Route exact path={`${process.env.PUBLIC_URL}/menu/:title/categories/:id/`} component={Categories}/>
                      
                      <Route exact path={`${process.env.PUBLIC_URL}/menu/:title/edit-category/:category/`} component={PlaceItems}/>
                      <Route exact path={`${process.env.PUBLIC_URL}/menu/:title/items/`} component={Items}/>
                      <Route exact path={`${process.env.PUBLIC_URL}/menu/:title/items/:id/`} component={Items}/>

                      <Route exact path={`${process.env.PUBLIC_URL}/menu/:title/design/`} component={Design}/>
